...
#   1. 等 16 個容器的 systemd 到達 running（degraded 容忍但會警告）
...
NODES=(lb-01 lb-02 app-01 app-02 app-03 pg-01 pg-02 pg-03 mq-01 mq-02 mq-03
       scylla-01 scylla-02 scylla-03 nfs-01 mgmt-01)
# 各節點的「主要 IP」（inventory 的 ansible_host，mgmt 由此 ssh 過去）
IPS=(10.20.10.11 10.20.10.12 10.20.20.11 10.20.20.12 10.20.20.13
...
docker exec email-proxy-mgmt-01 bash -c "
